...
class _TimerScreenState extends State<TimerScreen> {
      ...
      _timers[index] = Timer.periodic(const Duration(seconds: 1), (_) {
        ...
        if (current.inHours >= 24) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('${_provider.allDevices[index].name} ครบ 24 ชั่วโมงแล้ว!'),
  ...
  void _scrollLeft() {
    final target = (_scrollController.offset - 100).clamp(
      0.0,
  ...
  Widget build(BuildContext context) {
    ...
    if (_currentIndex >= devices.length) {
      _currentIndex = 0;
    }
                                      ...
                                      return GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            boxShadow: [
                                              BoxShadow(
                                                color: ap.iconColor.withOpacity(0.12),
                                                blurRadius: 8,
                                              ),
                                            ],
                                          ),
